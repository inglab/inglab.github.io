...
- **배수영** (소프트웨어 - 인공지능학과) *2024.02* - 성균관대 IIS Lab 박사 진학
- **김은총** (기계공 - 인공지능학과) *2023.02* - 크래프톤
- **현지웅** (소프트웨어 - 인공지능학과) *2022.08* - 뤼튼(Wrtn) AI-assisted writing  
- **박종혁** (인공지능학과) *2022.08*
- **성창민** (소프트웨어학과) *2022.08* - TmaxCoreAI 
...
- **박서희** (데이터사이언스 융합학과) *2020.08* - 현대해상 
- **김영준** (데이터사이언스 융합학과) *2020.02* - NCSoft 
- **소청** (전자전기컴퓨터학과) *2020.02* - 중국은행 (Bank of China) 총본부 IT부문
- **김유진** (데이터사이언스 융합학과) *2019.08* - IBM
